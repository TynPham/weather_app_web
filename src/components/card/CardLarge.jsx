  ...
  return (
    <div>
      {Object.keys(data).length === 0 ? (
        ...
        <>
          <img className="absolute right-0 rounded-tr-2xl" src="/assets/image/sun.png" alt="img" />
          <section className="md:min-h-430 min-h-500 relative flex flex-col items-center text-center text-white-always">
            ...
            <div className="md:gap-0 mt-4 flex flex-col gap-2">
              <img className="w-48" src={`/assets/image/${listWeatherImg[data.weather[0].icon]}`} alt="" />
              ...
              <span className="md:text-2xl text-1.35 font-semibold">{data.weather[0].main}</span>
